...
class _CartScreenState extends State<CartScreen> {
  ...
  void initState() {
    ...
    super.initState();
    cartController.getCartItems(authController.authModel!.data!.id!);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Obx(() {
        return (cartController.isLoading.value == true)
            ? const Center(
                          ...
                          SizedBox(
                            child: ListView.separated(
                              ...
                              itemCount: cartController
                                  .viewCartModel!.cart!.items!.length,
