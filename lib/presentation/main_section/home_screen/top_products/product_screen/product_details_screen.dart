...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void initState() {
    ...
    productDetailController.getProducttDetail(widget.productId);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        return productDetailController.isLoading.value == true
            ? const Center(
                child: CircularProgressIndicator(
                  color: Colors.black,
                ),
              )
            : productDetailController.isLoading.value == true
                ? const Center(
                    child: CircularProgressIndicator(
                      color: Colors.black,
                    ),
                    ...
                    child: Stack(
                      children: [
                            ...
                            child: Column(
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text(
                                      'Color: ${productDetailController.productDetailModel!.data!.setColor!}',
                                      style: GoogleFonts.poppins(
                                          fontSize: 15.px,
                                          fontWeight: FontWeight.w400,
                                ...
                                Row(
                                  children: [
                                    Text(
                                      '₹ ${productDetailController.productDetailModel!.data!.maxPrice!}',
                                      style: TextStyle(
                                          decoration:
                                    ...
                                    sizedBoxWidth10,
                                    Text(
                                      '₹${productDetailController.productDetailModel!.data!.minPrice!}',
                                      style: TextStyle(
                                          color: black,
                                          fontSize: 17.px,
                                    ...
                                    Spacer(),
                                    Text(
                                      'MOQ:  ${productDetailController.productDetailModel!.data!.noOfPairs!} Pcs',
                                      style: GoogleFonts.poppins(
                                          fontWeight: FontWeight.w400,
                                          fontSize: 13.px),
                                    )
                                ...
                                Flex(
                                  ...
                                  children: [
                                    Expanded(
                                        flex: 1,
                                        child:
                                            _buildIndicatorAndText("Quality")),
                                    Expanded(
                                        flex: 1,
                                        child: _buildIndicatorAndText(
                                            "Strong space")),
                                    Expanded(
                                        flex: 1,
                                        child:
                                            _buildIndicatorAndText("Design ")),
                                    Expanded(
                                        flex: 1,
                                        child: _buildIndicatorAndText(
                                            "Durability")),
                        ...
                        Positioned(
                            ...
                            right: Adaptive.w(3),
                            child:
                                Image.asset('assets/images/detailsstack.png'))
                      ],
                    ),
                  );
      }),
